...
if True:
    GT_PATH  = "/home/jovyan/data-vol-1/detreg/data/labv2/test/2d_yoloInt_gt"
    DR_PATH  = "/home/jovyan/data-vol-1/detreg/exps/imgNetDETReg_fine_tune_full_coco/txt" # labv2_messy3k_
    IMG_PATH = "/home/jovyan/data-vol-1/detreg/data/labv2/test/2d_yoloInt_img"
...
"""
if True:
    myD = { file.split(".")[0]:[0,0] for file in os.listdir("/home/jovyan/data-vol-1/detreg/data/labv2/test/2d_yoloInt_gt") } # fileID -> [t,f]
sum_AP = 0.0
ap_dictionary = {}
lamr_dictionary = {}
...
with open(output_files_path + "/output.txt", 'w') as output_file:
    ...
    for class_index, class_name in enumerate(gt_classes):
        ...
        #print(f"len(tp)={len(tp)}",f"len(fp)={len(fp)}")
        #print(f"tp={tp}"); print(f"fp={fp}")
