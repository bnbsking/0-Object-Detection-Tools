...
def main(args):
    ...
    if False: # pretrain only
        model.load_state_dict(torch.load("exps/official_weights/checkpoint_coco.pth"),strict=False)
    if True:
        test = False
        from zDataset import my_datasets
        #testPath="data/labv2/testv2/testv2"
        dataset_train, dataset_val, dataset_test = my_datasets(trainValPath="data/labv2/train/clean2dr", testPath="data/labv2/testv2/testv2", test=test)
        args.viz = test
