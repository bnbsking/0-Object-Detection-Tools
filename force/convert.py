...
# FormatConvertAny2General.voc2general(
#     img_path_list = sorted(glob.glob("../example/data/voc/*.jpg")),
#     ant_path_list = sorted(glob.glob("../example/data/voc/*.xml")),
#     class_list = ["dog", "cat"],
#     save_path = "./test_voc.json",
# )
# FormatConvertAny2General.yolo2general(
#     img_path_list = sorted(glob.glob("../example/data/yolo/*.jpg")),
#     ant_path_list = sorted(path for path in glob.glob("../example/data/yolo/*.txt") if "classes.txt" not in path),
#     class_list = ["dog", "cat"],
#     save_path = "./test_yolo.json",
# )
# FormatConvertAny2General.coco2general(
#     img_folder = "../example/data/coco",
#     ant_path = "../example/data/coco/coco.json",
#     save_path = "./test_coco.json",
# )
# FormatConvertGeneral2Any.general2voc(
#     ant_path = "./test_voc.json",
#     save_folder = "./test_voc"
# )
# FormatConvertGeneral2Any.general2yolo(
#     ant_path = "./test_yolo.json",
#     save_folder = "./test_yolo"
# )
# FormatConvertGeneral2Any.general2coco(
#     ant_path = "./test_coco.json",
#     save_folder = "./test_coco"
# )
# FormatConvertAny2Any.voc2coco(
#     img_path_list = sorted(glob.glob("../example/data/voc/*.jpg")),
#     ant_path_list = sorted(glob.glob("../example/data/voc/*.xml")),
#     class_list = ["dog", "cat"],
#     save_folder = "./voc2coco",
# )